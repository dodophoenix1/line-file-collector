...
- หากฐานข้อมูล MySQL เชื่อมต่ออยู่ Teacher PIN จะถูกบันทึกในตาราง `app_settings`; หากใช้ Drive fallback ระบบจะเก็บเฉพาะ hash ในไฟล์ settings ที่ไม่เปิดสาธารณะบนโฟลเดอร์ Drive และอยู่รอดหลัง restart
